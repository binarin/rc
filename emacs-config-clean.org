...
** Smart mode line
   #+BEGIN_SRC emacs-lisp
     ...
     (gsetq rm-blacklist
            (format "^ \\(%s\\)$"
                    (mapconcat #'identity
                               '("Projectile.*" "Undo-Tree" "ivy" "ElDoc" "Paredit")
                               "\\|"))
            rm-text-properties
...
** Autosave and backups
   ...
   #+BEGIN_SRC emacs-lisp
     (setq backup-directory-alist '(("." . "~/.emacs.d/backups-clean")))
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq auto-save-file-name-transforms '((".*" "~/.emacs.d/auto-save-list-clean/" t)))
   #+END_SRC
* Programming
** Projects
   #+BEGIN_SRC emacs-lisp
